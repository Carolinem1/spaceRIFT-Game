...
mainmenu_img = pygame.image.load('images/ch_.jpg').convert()
mainmenu_img = pygame.transform.scale(mainmenu_img, (WIDTH, HEIGHT))

logo_img = pygame.image.load('images/title_game.png').convert_alpha()
n_size = (500,500)  # Reemplaza nuevo_ancho y nuevo_alto con los valores deseados
logo_img = pygame.transform.scale(logo_img, n_size)
logo_x = 150
logo_y = -10

#play_button_rect = pygame.Rect(WIDTH // 2 - 100, HEIGHT // 2 - 25, 205, 50)
play_button_rect = pygame.Rect(200, 100, 100, 25)
quit_button_rect = pygame.Rect(200, 140, 100, 25)
