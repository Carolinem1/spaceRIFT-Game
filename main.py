...
from classes.constants import FPS, SHOOT_DELAY, WIDTH, HEIGHT
...
pygame.display.set_caption("SpaceRIFT")
clock = pygame.time.Clock()


def main():
    #bg_music=pygame.mixer.music.load('game_sounds/music.wav')
    bg_music = pygame.mixer.Sound('game_sounds/music.wav')
...
enemy1_img = [
    pygame.image.load('images/enemies/enemy1_1.png').convert_alpha(),
    pygame.image.load('images/enemies/enemy1_2.png').convert_alpha(),
    pygame.image.load('images/enemies/enemy1_3.png').convert_alpha()
]
enemy2_img = [
    pygame.image.load('images/enemies/enemy2_1.png').convert_alpha(),
    pygame.image.load('images/enemies/enemy2_2.png').convert_alpha()
]
...
while running:
    ...
    score_surface = pygame.font.Font('font/Pixeltype.ttf', 30).render(f'{score}', True, (238, 232, 170))
    ...
    hi_score_surface = pygame.font.Font('font/Pixeltype.ttf', 30).render(f'Puntaje Record: {hi_score}', True, (255, 255, 255))
